...
Multi-signature (multi-sig) technology adds an extra layer of security to your TB Wallet by requiring multiple approvals before any transaction can be executed. This feature is essential for protecting high-value assets and is ideal for both personal use and shared wallets.
...
1. **Access Multi-Sig Settings**: Navigate to Security settings in TB Wallet
...
TB Wallet's multi-signature feature supports:
...
1. **Create Transaction**: Draft the transaction in TB Wallet
...
Yes, TB Wallet supports hardware wallet integration for multi-signature setups, providing even greater security.
