export const SITE_METADATA = {
    title: ` – stories, insights, and ideas`,
    author: 'Leo Huynh',
    titleHeader: `Leo's dev blog`,
    description:
    ...
    siteLogo: `${process.env.NEXT_PUBLIC_BASE_PATH || ''}/static/images/logo.jpg`,
    socialBanner: `${process.env.NEXT_PUBLIC_BASE_PATH || ''}/static/images/twitter-card.jpeg`,
