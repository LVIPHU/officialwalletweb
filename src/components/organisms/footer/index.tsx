  ...
  return (
    <Container>
      <GlassCard className='mb-24 px-7 py-10'>
        <div className='grid grid-cols-2 gap-3 gap-y-8 py-10 max-sm:mx-auto max-sm:max-w-sm sm:grid-cols-4 md:gap-8 lg:grid-cols-7'>
          <div className='col-span-full mb-10 flex flex-col items-center justify-center gap-5 lg:col-span-2 lg:mb-0 lg:justify-start'>
            <NavigationLink href='#'>
              <Logo size='3xl' />
            </NavigationLink>
            <p className='text-5xl font-black'>TBChat</p>
          </div>

          {/* Link Columns */}
          {Object.entries(NAVIGATION_ITEMS).map(([title, links]) => (
            <div key={title} className='text-left lg:mx-auto'>
              <h4 className='mb-7 text-lg font-medium text-gray-900 capitalize dark:text-white'>{title}</h4>
        ...
        <div className='py-7'>
          <div className='flex flex-col items-center justify-center lg:flex-row lg:justify-between'>
            <span className='text-sm text-gray-500 dark:text-gray-400'>
              © Copyright 2025 by{' '}
              <NavigationLink href='#' className='hover:text-indigo-600 dark:hover:text-indigo-400'>
                TB Wallet
              </NavigationLink>
            </span>
            <div className='mt-4 flex space-x-4 sm:justify-center lg:mt-0'>
              {socialLinks.map((link) => (
                <NavigationLink
                  ...
                  className='flex h-9 w-9 items-center justify-center rounded-full bg-gray-700 transition-colors duration-300 hover:bg-indigo-600 dark:bg-gray-600 dark:hover:bg-indigo-500'
                >
                  {link.icon}
                </NavigationLink>
              ))}
