  ...
  return (
    <div
      className={cn(
        ...
        'first:md:ml-4 last:md:mr-4 first:lg:ml-12 last:lg:mr-12 first:xl:ml-24 last:xl:mr-24 first:2xl:ml-38 last:2xl:mr-38',
        className
      )}
    >
      <div className='col-span-5 flex items-center justify-center md:col-start-8'>
        <div className='relative flex flex-col items-center justify-center gap-7 md:items-start md:pt-17'>
